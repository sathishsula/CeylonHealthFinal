...
const PharPrescriptionDashboard = () => {
                ...
                <div className="nav-bar">
                    ...
                    <a href="/pharmacy">
                        ...
                        <a href="/pharmacyStock">
                            ...
                            <li className="nav-element">Stock</li>
                        </a>
                        <a href="/prescription">
                        
                            <li className="nav-element active-element">Prescriptions</li>
                        </a>
                        <a href="cart">
...
export default PharPrescriptionDashboard;